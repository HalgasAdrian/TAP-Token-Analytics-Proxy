...
(completion) rates. Keep in sync with https://developers.openai.com/api/docs/pricing

Cached input is not yet modelled: OpenAI bills repeated prompt prefixes at a
fraction of the input rate, so cost is overstated for callers who benefit from
prompt caching.
"""
